...
//                                 <Input type="text" className="border-2 border-blue-400 rounded-none block  bg-gray-100 focus:border-gray-500 text-gray-800 appearance-none w-full py-2 px-3 leading-tight focus:outline-none mt-5" placeholder="password" onChange={onChangePassword}
//                                     validations={[required]} />
